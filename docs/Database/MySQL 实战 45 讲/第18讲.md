...
<img src="../assets/3e30d9a5e67f711f5af2e2599e800286-1584367393577.png" alt="图1 t_modified 索引示意图">
  <figcaption>图1 t_modified 索引示意图</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/27c2f5ff3549b18ba37a28f4919f3655-1584367393739.png" alt="图2 explain 结果">
  <figcaption>图2 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/2b67fc38f1651e2622fe21d49950b214-1584367393743.png" alt="图3 MySQL 中字符串和数字转换的效果示意图">
  <figcaption>图3 MySQL 中字符串和数字转换的效果示意图</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ```
  <figcaption>图4 语句 Q1 的 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/8289c184c8529acea0269a7460dc62a9-1584367393746.png" alt="图5 语句 Q1 的执行过程">
  <figcaption>图5 语句 Q1 的执行过程</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/92cb498ceb3557e41700fae53ce9bd11-1584367393752.png" alt="图6 explain 结果">
...
<figure markdown="span">
<img src="../assets/aa844a7bf35d330b9ec96fc159331bd6-1584367393757.png" alt="图7 SQL 语句优化后的 explain 结果">
  <figcaption>图7 SQL 语句优化后的 explain 结果</figcaption>
</figure>
...
!!! Quote "这次评论区出现了很多很棒的留言"

    @老杨同志 提出了重新整理的方法、@雪中鼠 提到了用 rowid 的方法，是类似的思路，就是让表里面保存一个无空洞的自增值，这样就可以用我们的随机算法 1 来实现；
