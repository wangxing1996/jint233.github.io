...
安装完成后，按照第一课中提供的方案配置 Java\_HOME、PATH 环境变量，并验证是否安装成功：
...
* [https://www.usenix.org/legacy/events/vee05/full\_papers/p46-click.pdf](https://www.usenix.org/legacy/events/vee05/full_papers/p46-click.pdf)
