...
![Drawing 4.png](assets/CgqCHl9sTuuAc0_4AAHBe2Lt3do732.png) ![Drawing 5.png](assets/Ciqc1F9sTvCAY2NvAAEtJYxCA_8121.png)
...
1. 在创建 Chunk 产物代码阶段，若命中缓存 **Chunk** ，则直接跳过该 Chunk 的产物代码生成过程。
