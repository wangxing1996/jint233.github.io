...
2. 管理Docker应用配置工具的选择，比如[Ansible](https://www.ansible.com/home)、[Tereform](https://www.terraform.io/)。
3. Host主机系统的选择，比如[CoreOS](https://coreos.com/)、[Atomic](https://www.projectatomic.io/)、[Ubuntu](https://docs.docker.com/installation/ubuntulinux/)。
