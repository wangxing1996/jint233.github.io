...
<img src="../assets/fd75a2b37ae6ca709b7f16fe060c2c10-1584367395065.png" alt="图1 MySQL 主备切换流程">
  <figcaption>图1 MySQL 主备切换流程</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/a66c154c1bc51e071dd2cc8c1d6ca6a3-1584367397412.png" alt="图2 主备流程图">
  <figcaption>图2 主备流程图</figcaption>
</figure>
...
我在 [第 15 讲](../第15讲) 中，和你提到过 binlog 有两种格式，一种是 statement，一种是 row。可能你在其他资料上还会看到有第三种格式，叫作 mixed，其实它就是前两种格式的混合。
...
<figure markdown="span">
<img src="../assets/b9818f73cd7d38a96ddcb75350b52931-1584367397413.png" alt="图3 statement 格式 binlog 示例">
  <figcaption>图3 statement 格式 binlog 示例</figcaption>
</figure>
...
- 最后一行是一个 COMMIT。你可以看到里面写着 xid=61。你还记得这个 XID 是做什么用的吗？如果记忆模糊了，可以再回顾一下 [第 15 讲](../第15讲) 中的相关内容。

为了说明 statement 和 row 格式的区别，我们来看一下这条 delete 命令的执行效果图：

<figure markdown="span">
<img src="../assets/96c2be9c0fcbff66883118526b26652b-1584367397421.png" alt="图4 delete 执行 warnings">
  <figcaption>图4 delete 执行 warnings</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/d67a38db154afff610ae3bb64e266826-1584367389320.png" alt="图5 row 格式 binlog 示例">
  <figcaption>图5 row 格式 binlog 示例</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/c342cf480d23b05d30a294b114cebfc2-1584367389357.png" alt="图6 row 格式 binlog 示例的详细信息">
  <figcaption>图6 row 格式 binlog 示例的详细信息</figcaption>
</figure>
...
当然我要说的是，现在越来越多的场景要求把 MySQL 的 binlog 格式设置成 row。这么做的理由有很多，我来给你举一个可以直接看出来的好处：
...
<figure markdown="span">
<img src="../assets/0150301698979255a6f27711c35e9eef-1584367389377.png" alt="图7 mixed 格式和 now()">
  <figcaption>图7 mixed 格式和 now()</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/1ad3a4c4b9a71955edba5195757dd041-1584367389377.png" alt="图8 TIMESTAMP 命令">
  <figcaption>图8 TIMESTAMP 命令</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/20ad4e163115198dc6cf372d5116c956-1584367389406.png" alt="图9 MySQL 主备切换流程 -- 双 M 结构">
  <figcaption>图9 MySQL 主备切换流程 -- 双 M 结构</figcaption>
</figure>
