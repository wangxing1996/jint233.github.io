...
<img src="../assets/8acdcefcaf5c9940570bf7e8f73dbdde-1584367407247.png" alt="图1 mysqldump 输出文件的部分结果">
  <figcaption>图1 mysqldump 输出文件的部分结果</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/3a6790bc933af5ac45a75deba0f52cfd-1584367390347.jpg" alt="图2 load data 的同步流程">
  <figcaption>图2 load data 的同步流程</figcaption>
</figure>
...
<figure markdown="span">
<img src="../assets/ba1ced43eed4a55d49435c062fee21a7-1584367390359.jpg" alt="图3 物理拷贝表">
  <figcaption>图3 物理拷贝表</figcaption>
</figure>
...
!!! Quote "评论区留言点赞板"
    ...
    这是因为 next-key lock 是先加间隙锁，再加记录锁的。加间隙锁成功了，加记录锁就会被堵住。如果你对这个过程有疑问的话，可以再复习一下 [第 30 讲](../第30讲) 中的相关内容。
