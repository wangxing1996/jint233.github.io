...
我们可将 doBusiness 方法看成是远程调用，例如调用第三方的接口，接口名称为“<http://wujiuye.com/hello2”，使用> POST 方式调用，那么我们可以使用“POST:<http://wujiuye.com/hello2”作为资源名称，并将流量类型设置为> OUT 类型。上下文名称取名为"my\_context"。
