...
![img](assets/v2-bf3a8087ed9440b0524855852a3bdbbf_1440w.jpg)
...
GenCollectedHeap::expand\_heap\_and\_allocate()
...
![img](assets/v2-2f1f3f2bfc3d85ccabb80cfe39267ddf_1440w.jpg)
...
![img](assets/v2-e9226cf558ac9709e18469212197d6e5_1440w.jpg)
...
* scrub symbol table 表示清理元数据符号引用耗时，符号引用是 Java 代码被编译成字节码时，方法在 JVM 中的表现形式，生命周期一般与 Class 一致，当 \_should\_unload\_classes 被设置为 true 时在 CMSCollector::refProcessingWork() 中与 Class Unload、String Table 一起被处理。
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-3fb139cff7ad872397792d4d598b1f63_1440w.jpg)
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-5becf452ba0b7c23ae20712647f629df_1440w.jpg)

最终定位到是，项目中对 GIPInputStream 的使用错误，没有正确的 close()。

![img](../%E6%96%87%E7%AB%A0/assets/v2-f1b3690844164ac3cd1f6a4a6cbcdf00_1440w.jpg)
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-e188cc9d9b0773fdf081225bf35cceed_1440w.jpg)
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-7248fbaf7dceb99e7803e6e907d18ae5_1440w.jpg)
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-d5dce299d725fea10f4ae7e6d56f9498_1440w.jpg)
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-45516be9a66e2a15ffa8f3d1be1db5c6_1440w.jpg)**5.3 调优建议**
------------
...
![img](../%E6%96%87%E7%AB%A0/assets/v2-1f760f2fac0548b6dd872614fb506dc1_1440w.jpg)
...
更多内容，请查看：[美团技术团队：Java中9种常见的CMS GC问题分析与解决（上）](https://zhuanlan.zhihu.com/p/291027786)**7\. 参考资料**============
...
\[10\]《[Stuff Happens：Understanding Causation in Policy and Strategy](https://go.gale.com/ps/anonymous?id=GALE|A563359212&sid=googleScholar&v=2.1&it=r&linkaccess=abs&issn=00311723&p=AONE&sw=w)》AA Hill**8\. 作者简介**
============
