...
![img](assets/v2-9f7fac70f0ac066f4669b481f77b6026_1440w.jpg)
...
拦截逻辑的流程：
![img](assets/v2-ae0219c9892e3c116380dd2c3c4cb305_1440w.jpg)
...
`getExpression` 方法会从 expressionCache 中获取到 @LogRecordAnnotation 注解上的表达式的解析 Expression 的实例，然后调用 `getValue` 方法，`getValue` 传入一个 evalContext 就是类似上面例子中的 order 对象。其中 Context 的实现将会在下文介绍。**日志上下文实现**
...
上面代码的执行流程如下：
![img](assets/v2-bfb13b96fc1bb1feb1aae3a833965678_1440w.jpg)
